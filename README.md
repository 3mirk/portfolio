...
|`Nested Substing_Index`   | Create MySQL view parsing semi-structured column using CTE's and Nested SUBSTRING_INDEX Calls.    |[link](https://github.com/3mirk/Process-Control-SQL-PowerBI-Integration) |
