...
|`Process Overview`   | Daily Adherence to Process Control standards and log view for individual records.  | [link](https://public.tableau.com/app/profile/ahmet.emir.kara/viz/ProcessControlOverviewv2/DailyOverview)|
...
|`SQL View Creation: Parsed Column`   | Create MySQL view parsing semi-structured column using CTE's and Nested SUBSTRING_INDEX Calls.    |[link](https://github.com/3mirk/Process-Control-SQL-PowerBI-Integration) |
